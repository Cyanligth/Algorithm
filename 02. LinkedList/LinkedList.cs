    ...
    public class LinkedList<T>
    {
        ...
        public LinkedListNode<T> AddFirst(T value)      // 제일 앞에 끼워넣기
        {
            ...
            if(head != null)    // 머리가 공백이 아닌 경우
            {
                ...
                newNode = head;     // 지금부터 뉴노드가 머리다.
            }
            else        // 그 외의 경우
            {
                newNode = head;     // 뉴노드가 머리이자
                newNode = tail;     // 동시에 꼬리이다
            }
            count++;        // 카운트 +1
        ...
        public void RemoveFirst()       // 연결리스트 머리 지우기
        {
            ...
            head.next = head;       // 머리의 다음이 가리키는 노드를 머리로 설정
            count--;        // 카운트 -1
        }
        ...
        public void RemoveLast()        // 연결리스트 꼬리 지우기
        {
            ...
            tail.prev = tail;       // 머리의 이전이 가리키는 노드를 꼬리로 설정
            count--;        // 카운트 -1
        }
